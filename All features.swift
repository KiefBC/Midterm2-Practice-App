...
//                .symbolVariant(.fill)
                ...
                Image(systemName: "gauge.with.dots.needle.\(Int(current))percent")
                                .resizable()
                                .scaledToFit()
...
struct DocumentComposerView: View {
    ...
    var isValidInput: Bool {
        ...
        return inputText.unicodeScalars.allSatisfy { allowedCharacters.contains($0) }
    }
    ...
    func savePDFFile() {
        ...
        do {
            try renderer.writePDF(to: fileURL) { context in
                ...
                inputText.draw(in: CGRect(x: 20, y: 20, width: pageWidth - 40, height: pageHeight - 40), withAttributes: attributes)
            }
